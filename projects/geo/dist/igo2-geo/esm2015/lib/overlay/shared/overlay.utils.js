 ...
 * @return {?} Style
 */
export function createOverlayDefaultStyle({ text, fillOpacity, strokeWidth = 2, strokeOpacity, color = [0, 161, 222, 0.3], strokeColor } = {}) {
    /** @type {?} */
 ...
 * @return {?} Style
 */
export function createOverlayMarkerStyle({ text, opacity = 1, color = 'blue', outlineColor } = {}) {
    /** @type {?} */
    let iconColor;
    /** @type {?} */
    let svgIconColor;

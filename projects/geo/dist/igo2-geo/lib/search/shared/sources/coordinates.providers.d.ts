 ...
 * @ignore
 */
export declare function CoordinatesReverseSearchSourceFactory(config: ConfigService, languageService: LanguageService, _projectionService: ProjectionService): CoordinatesReverseSearchSource;
/**
...
export declare function provideCoordinatesReverseSearchSource(): {
    ...
    multi: boolean;
    deps: (typeof ConfigService | typeof LanguageService | typeof ProjectionService)[];
};

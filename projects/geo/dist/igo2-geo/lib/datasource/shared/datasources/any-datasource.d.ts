...
export declare type AnyDataSource = DataSource | OSMDataSource | FeatureDataSource | WFSDataSource | XYZDataSource | WMTSDataSource | WMSDataSource | CartoDataSource | ArcGISRestDataSource | TileArcGISRestDataSource | WebSocketDataSource | MVTDataSource | ClusterDataSource;

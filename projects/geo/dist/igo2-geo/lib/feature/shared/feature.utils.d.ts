...
export declare function renderFeatureFromOl(olRenderFeature: OlRenderFeature, projectionIn: string, olLayer?: OlLayer, projectionOut?: string): Feature;
/**
 ...
 */
export declare function computeOlFeaturesDiff(source: OlFeature[], target: OlFeature[]): {
    add: OlFeature[];
    remove: OlFeature;
};

...
import { EntityOperationType, EntityTableColumnRenderer } from './entity.enums';
import { EntityStore } from './store';
export declare type EntityKey = string | number;
...
export declare type EntityFilterClause<E = object> = (entity: E) => boolean;

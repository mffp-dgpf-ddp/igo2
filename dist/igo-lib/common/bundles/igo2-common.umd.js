(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/portal'), require('@angular/cdk/overlay'), require('@angular/platform-browser'), require('typy'), require('@angular/common/http'), require('@angular/forms'), require('@igo2/core'), require('@angular/material'), require('@angular/cdk/collections'), require('@angular/cdk/table'), require('@igo2/utils'), require('@angular/animations'), require('@angular/common'), require('@angular/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@igo2/common', ['exports', '@angular/cdk/portal', '@angular/cdk/overlay', '@angular/platform-browser', 'typy', '@angular/common/http', '@angular/forms', '@igo2/core', '@angular/material', '@angular/cdk/collections', '@angular/cdk/table', '@igo2/utils', '@angular/animations', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (factory((global.igo2 = global.igo2 || {}, global.igo2.common = {}),global.ng.cdk.portal,global.ng.cdk.overlay,global.ng.platformBrowser,global.t,global.ng.common.http,global.ng.forms,global.core,global.ng.material,global.ng.cdk.collections,global.ng.cdk.table,global.utils,global.ng.animations,global.ng.common,global.ng.core,global.rxjs,global.rxjs.operators));
}(this, (function (exports,portal,overlay,platformBrowser,t,http,i1,core,material,collections,table,utils,animations,common,i0,rxjs,operators) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */ EntityView = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.values$$ = rxjs.combineLatest(source$, this.filter$, this.sort$)
                    .pipe(operators.skip(1), operators.debounceTime(25))
                    .subscribe(( /**
             * @param {?} bunch
             * @return {?}
             */function (bunch) {
                    var _a = __read(bunch, 3), _values = _a[0], filter = _a[1], sort = _a[2];
                    /** @type {?} */
         ...
         */
            function () {
                var _this = this;
                /** @type {?} */
                var sources$ = [this.source$, rxjs.combineLatest.apply(void 0, __spread(this.joins.map(( /**
                         * @param {?} join
                         * @return {?}
                         */function (join) { return join.source; }))))];
                return rxjs.combineLatest.apply(void 0, __spread(sources$)).pipe(operators.map(( /**
                 * @param {?} bunch
                 * @return {?}
                 */function (bunch) {
         ...
         */
            function (values, clause) {
                 ...
                 * @return {?}
                 */function (v1, v2) {
                    return utils.ObjectUtils.naturalCompare(clause.valueAccessor(v1), clause.valueAccessor(v2), clause.direction);
                }));
            };
        /**
         * @private
         ...
         */
            function () {
                ...
                try {
                    ...
                    try {
                        if (storeKeys_1_1 && !storeKeys_1_1.done && (_a = storeKeys_1.return))
                            _a.call(storeKeys_1);
                    }
                    finally {
                        if (e_1)
     ...
     */ EntityTransaction = /** @class */ (function () {
         ...
         */
             ...
             * @return {?}
             */function () { return rxjs.of(new Error()); })), operators.tap(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) {
         ...
         */
            function (operations) {
                ...
                try {
                    ...
                    try {
                        if (operations_1_1 && !operations_1_1.done && (_a = operations_1.return))
                            _a.call(operations_1);
                    }
                    finally {
                        if (e_1)
                            throw e_1.error;
    ...
    var EntitySelectorComponent = /** @class */ (function () {
        ...
        EntitySelectorComponent.propDecorators = {
            store: [{ type: i0.Input }],
            titleAccessor: [{ type: i0.Input }],
            emptyText: [{ type: i0.Input }],
            multi: [{ type: i0.Input }],
            multiAllText: [{ type: i0.Input }],
            multiNoneText: [{ type: i0.Input }],
    ...
    var EntityTableComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        EntityTableComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef }
            ];
        };
        EntityTableComponent.propDecorators = {
            ...
            scrollBehavior: [{ type: i0.Input }],
            entityClick: [{ type: i0.Output }],
            entitySelectChange: [{ type: i0.Output }]
        };
    ...
    var ActionbarComponent = /** @class */ (function () {
        function ActionbarComponent(cdRef, overlay$$1) {
            var _this = this;
            this.cdRef = cdRef;
        ...
        ActionbarComponent.propDecorators = {
            store: [{ type: i0.Input }],
            mode: [{ type: i0.Input }],
            withToggleButton: [{ type: i0.Input }],
            horizontal: [{ type: i0.Input }],
            color: [{ type: i0.Input }],
            withTitle: [{ type: i0.Input }],
            withIcon: [{ type: i0.Input }],
            xPosition: [{ type: i0.Input }],
            yPosition: [{ type: i0.Input }],
            overlayClass: [{ type: i0.Input }],
            itemClassFunc: [{ type: i0.Input }],
            withTitleClass: [{ type: i0.HostBinding, args: ['class.with-title',] }],
            withIconClass: [{ type: i0.HostBinding, args: ['class.with-icon',] }],
            horizontalClass: [{ type: i0.HostBinding, args: ['class.horizontal',] }]
        };
    ...
    var ClickoutDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        ClickoutDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        ClickoutDirective.propDecorators = {
            clickout: [{ type: i0.Output }],
            handleMouseClick: [{ type: i0.HostListener, args: ['document:click', ['$event', '$event.target'],] }]
        };
    ...
    var IgoCollapsibleModule = /** @class */ (function () {
        ...
        IgoCollapsibleModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [material.MatIconModule, material.MatListModule],
    ...
    var IgoConfirmDialogModule = /** @class */ (function () {
        ...
        IgoConfirmDialogModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [material.MatButtonModule, material.MatDialogModule, core.IgoLanguageModule],
    ...
    var ContextMenuDirective = /** @class */ (function () {
        function ContextMenuDirective(overlay$$1, viewContainerRef, elementRef) {
            this.overlay = overlay$$1;
        ...
        ContextMenuDirective.propDecorators = {
            menuContext: [{ type: i0.Input, args: ['igoContextMenu',] }],
            menuPosition: [{ type: i0.Output }],
    ...
    var SanitizeHtmlPipe = /** @class */ (function () {
        ...
        SanitizeHtmlPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'sanitizeHtml' },] }
        ];
        /** @nocollapse */
    ...
    var DynamicOutletComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DynamicOutletComponent.ctorParameters = function () {
            return [
    ...
    var FlexibleComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FlexibleComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: core.MediaService }
            ];
        };
        FlexibleComponent.propDecorators = {
            main: [{ type: i0.ViewChild, args: ['flexibleMain',] }],
            initial: [{ type: i0.Input }],
            collapsed: [{ type: i0.Input }],
            expanded: [{ type: i0.Input }],
            initialMobile: [{ type: i0.Input }],
            collapsedMobile: [{ type: i0.Input }],
            expandedMobile: [{ type: i0.Input }],
    ...
    var FormComponent = /** @class */ (function () {
        ...
        FormComponent.propDecorators = {
            ...
            buttons: [{ type: i0.ViewChild, args: ['buttons',] }]
        };
    ...
    var FormFieldComponent$1 = /** @class */ (function () {
        ...
        /** @nocollapse */
        FormFieldComponent$$1.ctorParameters = function () {
            return [
    ...
    var EntityTableRowDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        EntityTableRowDirective.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
                { type: i0.ElementRef }
            ];
        ...
        EntityTableRowDirective.propDecorators = {
            ...
            selectOnClick: [{ type: i0.Input }],
            highlightSelection: [{ type: i0.Input }],
    ...
    var SecureImagePipe = /** @class */ (function () {
        function SecureImagePipe(http$$1) {
            this.http = http$$1;
        }
        /**
         * @param {?} url
        ...
        /** @nocollapse */
        SecureImagePipe.ctorParameters = function () {
            return [
    ...
    var JsonDialogComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        JsonDialogComponent.ctorParameters = function () {
            return [
                { type: material.MatDialogRef }
            ];
        };
    ...
    var JsonDialogService = /** @class */ (function () {
        ...
        /** @nocollapse */
        JsonDialogService.ctorParameters = function () {
            return [
                { type: material.MatDialog }
            ];
        };
    ...
    var IgoJsonDialogModule = /** @class */ (function () {
        ...
        IgoJsonDialogModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, material.MatButtonModule, material.MatDialogModule, IgoKeyValueModule],
    ...
    var ListItemDirective = /** @class */ (function () {
        ...
        ListItemDirective.propDecorators = {
            ...
            beforeFocus: [{ type: i0.Output }],
            beforeUnselect: [{ type: i0.Output }],
            beforeUnfocus: [{ type: i0.Output }],
            beforeDisable: [{ type: i0.Output }],
            beforeEnable: [{ type: i0.Output }],
            focus: [{ type: i0.Output }],
            unfocus: [{ type: i0.Output }],
            select: [{ type: i0.Output }],
            unselect: [{ type: i0.Output }],
            disable: [{ type: i0.Output }],
            enable: [{ type: i0.Output }],
            onClick: [{ type: i0.HostListener, args: ['click',] }]
        };
    ...
    var ListComponent = /** @class */ (function () {
        ...
        ListComponent.propDecorators = {
            ...
            selection: [{ type: i0.Input }],
            listItems: [{ type: i0.ContentChildren, args: [ListItemDirective, { descendants: true },] }],
    ...
    var IgoListModule = /** @class */ (function () {
        ...
        IgoListModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, material.MatIconModule, material.MatListModule, IgoClickoutModule],
    ...
    var PanelComponent = /** @class */ (function () {
        ...
        PanelComponent.propDecorators = {
            title: [{ type: i0.Input }],
            withHeader: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.igo-panel-with-header',] }]
        };
    ...
    var SidenavShimDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        SidenavShimDirective.ctorParameters = function () {
            return [
                { type: material.MatSidenav, decorators: [{ type: i0.Self }] },
                { type: i0.Renderer2 }
            ];
        };
        SidenavShimDirective.propDecorators = {
            onOpen: [{ type: i0.HostListener, args: ['open', ['$event'],] }],
            onCloseStart: [{ type: i0.HostListener, args: ['close-start', ['$event'],] }],
            onClose: [{ type: i0.HostListener, args: ['close', ['$event'],] }]
        };
    ...
    var SpinnerActivityDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        SpinnerActivityDirective.ctorParameters = function () {
            return [
                { type: SpinnerComponent, decorators: [{ type: i0.Self }] },
                { type: core.ActivityService }
            ];
        };
    ...
    var TableDataSource = /** @class */ (function (_super) {
        ...
        TableDataSource.prototype.connect =
            ...
            function () {
                ...
                return rxjs.merge.apply(void 0, __spread(displayDataChanges)).pipe(operators.map(( /**
                 * @return {?}
                 */function () {
         ...
         */
            function (data) {
                 ...
                 * @param {?} c
                 * @return {?}
                 */function (c) { return utils.ObjectUtils.resolve(item, c.name); }))
                        .join(' ')
                        .toLowerCase();
    ...
    var TableComponent = /** @class */ (function () {
        ...
        TableComponent.propDecorators = {
            database: [{ type: i0.Input }],
            model: [{ type: i0.Input }],
            hasFilterInput: [{ type: i0.Input }],
            select: [{ type: i0.Output }],
            filter: [{ type: i0.ViewChild, args: ['filter',] }],
    ...
    var WidgetService = /** @class */ (function () {
        ...
        /** @nocollapse */ WidgetService.ngInjectableDef = i0.defineInjectable({ factory: function WidgetService_Factory() { return new WidgetService(i0.inject(DynamicComponentService)); }, token: WidgetService, providedIn: "root" });
    ...
    var WorkspaceWidgetOutletComponent = /** @class */ (function () {
        ...
        WorkspaceWidgetOutletComponent.propDecorators = {
            workspace: [{ type: i0.Input }],
            deactivateWidget: [{ type: i0.Output }]
        };
            ...
            function () {
                ...
                if (this.actionStore !== undefined) {
                    this.change$ = this.change
                        .pipe(operators.debounceTime(35))
                        .subscribe(( /**
                 * @return {?}
    ...
    exports.ActionbarMode = ActionbarMode;
    ...
    exports.EntityOperationType = EntityOperationType;
    exports.EntityTableColumnRenderer = EntityTableColumnRenderer;
    exports.EntityTableScrollBehavior = EntityTableScrollBehavior;
    exports.EntityTableSelectionState = EntityTableSelectionState;
    ...
    exports.TableActionColor = TableActionColor;
    ...
    exports.ɵb = ActionbarItemComponent;
    exports.ɵa = ActionbarComponent;
    exports.ɵc = BackdropComponent;
    exports.ɵd = ClickoutDirective;
    exports.ɵe = ClonePipe;
    exports.ɵg = CollapseDirective;
    exports.ɵf = CollapsibleComponent;
    exports.ɵh = ConfirmDialogComponent;
    exports.ɵi = ConfirmDialogService;
    exports.ɵj = ContextMenuDirective;
    exports.ɵl = CustomHtmlComponent;
    exports.ɵk = SanitizeHtmlPipe;
    exports.ɵm = DragAndDropDirective;
    exports.ɵn = DynamicOutletComponent;
    exports.ɵo = DynamicComponentService;
    exports.ɵz = EntitySelectorComponent;
    exports.ɵbd = EntityTableRowDirective;
    exports.ɵbc = EntityTableComponent;
    exports.ɵp = FlexibleComponent;
    exports.ɵs = FormFieldSelectComponent;
    exports.ɵu = FormFieldTextComponent;
    exports.ɵv = FormFieldTextareaComponent;
    exports.ɵq = FormFieldComponent$1;
    exports.ɵw = FormGroupComponent;
    exports.ɵx = FormComponent;
    exports.ɵt = FormFieldComponent;
    exports.ɵr = FormFieldService;
    exports.ɵy = FormService;
    exports.ɵbe = SecureImagePipe;
    exports.ɵbg = JsonDialogComponent;
    exports.ɵbh = JsonDialogService;
    exports.ɵbf = KeyValuePipe;
    exports.ɵbi = ListItemDirective;
    exports.ɵbj = ListComponent;
    exports.ɵbk = PanelComponent;
    exports.ɵbl = SidenavShimDirective;
    exports.ɵbm = SpinnerActivityDirective;
    exports.ɵbn = SpinnerComponent;
    exports.ɵba = StopDropPropagationDirective;
    exports.ɵbb = StopPropagationDirective;
    exports.ɵbo = TableComponent;
    exports.ɵbr = ToolService;
    exports.ɵbq = toolSlideInOut;
    exports.ɵbp = ToolboxComponent;
    exports.ɵbt = WidgetService;
    exports.ɵbs = WidgetOutletComponent;
    exports.ɵbu = WorkspaceWidgetOutletComponent;

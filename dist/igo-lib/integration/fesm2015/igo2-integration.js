...
import { IgoMap, MapService, ProjectionService, LayerListControlsEnum, CatalogService, FeatureStore, IgoMeasurerModule, SearchSourceService, moveToOlFeatures, FeatureMotion, FEATURE, LAYER, LayerService, IgoCatalogModule, IgoFilterModule, IgoImportExportModule, IgoLayerModule, IgoMetadataModule, IgoDownloadModule, IgoPrintModule, IgoFeatureModule, IgoSearchModule, IgoFeatureDetailsModule, IgoCatalogBrowserModule, IgoCatalogLibraryModule } from '@igo2/geo';
...
import { Component, Injectable, NgModule, CUSTOM_ELEMENTS_SCHEMA, defineInjectable, inject, Input, ChangeDetectionStrategy } from '@angular/core';
...
/** @nocollapse */
ContextPermissionManagerToolComponent.ctorParameters = () => [];
